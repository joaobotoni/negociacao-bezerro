...
public final class NavigationHelper {
    ...
    public static void navigateOnMenuItem(@NonNull Fragment fragment, @IdRes int destinoAtual, @NonNull NavDirections direcoes, @NonNull MaterialToolbar toolbar, @IdRes int menuItemId) {
