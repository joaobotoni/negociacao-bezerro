...
import com.omni.negociacaobezerros.databinding.ItemLocalizacaoBinding;
...
public class LocalizacaoAdapter extends ListAdapter<Address, LocalizacaoAdapter.ViewHolder> {
    ...
    public LocalizacaoAdapter(OnClickListener listener) {
    ...
    public void submitList(@Nullable List<Address> list) {
        ...
        for (Address address : list) {
            if (noneNull(address.getLocality(), address.getAdminArea())) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(ItemLocalizacaoBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false), listener);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemLocalizacaoBinding binding;
        private Address item;

        ViewHolder(ItemLocalizacaoBinding binding, OnClickListener listener) {
