...
import static com.omni.negociacaobezerros.ui.state.negociacao.StatusNegociacao.PRE_CALCULADA;
...
public class NegociacaoViewModel extends ViewModel {
    ...
    private NegociacaoState atualizarPropostaPorCabeca(CotacaoState cotacao, FechamentoState fechamento,
                                                       BigDecimal novoValorPorCabeca, BigDecimal peso, Integer quantidade,
                                                       BigDecimal fretePorKg, StatusFrete statusFrete) {
    ...
    private NegociacaoState atualizarPropostaEFechamento(CotacaoState cotacao, FechamentoState fechamento,
                                                         BigDecimal valorPorKg, BigDecimal valorPorCabeca,
                                                         BigDecimal peso, Integer quantidade,
                                                         BigDecimal fretePorKg, StatusFrete statusFrete) {
    ...
    private PropostaState novaProposta(BigDecimal valorPorKg, BigDecimal valorPorCabeca,
                                       Integer quantidade, BigDecimal fretePorKg, StatusFrete statusFrete) {
        return new PropostaState(valorPorKg, valorPorCabeca, calcularTotalLote(valorPorCabeca, quantidade), fretePorKg, statusFrete);
    }

    private FechamentoState novoFechamento(BigDecimal valorPorKg, BigDecimal valorPorCabeca,
                                           BigDecimal valorTotal, BigDecimal comissaoPorKg) {
        return new FechamentoState(valorPorKg, valorPorCabeca, valorTotal, comissaoPorKg);
    }

    private FechamentoState atualizarFechamento(FechamentoState fechamento, BigDecimal valorPorKgProposta,
                                                BigDecimal fretePorKg, BigDecimal peso, Integer quantidade) {
        if (fechamento == null || fechamento.getComissaoPorKg() == null) return fechamento;
        BigDecimal novoValorPorKg = valorPorKgProposta.add(fretePorKg).add(fechamento.getComissaoPorKg())
